...
namespace XblConfig
{
    ...
    internal class Program
    {
        ...
        [Verb("getDocuments", HelpText = "Gets documents.")]
        ...
        [Verb("getSchemas", HelpText = "Gets document schemas.")]
        ...
        [Verb("getProducts", HelpText = "Gets products for given account.")]
        ...
        [Verb("getProduct", HelpText = "Gets a product.")]
        ...
        [Verb("getRelyingPartyDocument", HelpText = "Gets a specific relying party document for a given account.")]
        ...
        [Verb("getWebServices", HelpText = "Gets a list of web services for a given account.")]
        ...
        [Verb("createWebService", HelpText = "Create a new web service.")]
        ...
        [Verb("updateWebService", HelpText = "Update a web service.")]
        ...
        [Verb("deleteWebService", HelpText = "Delete a web service.")]
        ...
        [Verb("generateWebServiceCert", HelpText = "Generates a web service certificate.")]
        ...
        [Verb("getPublishStatus", HelpText = "Gets the publish status.")]
        ...
        [Verb("getAchievementImage", HelpText = "Gets the details of an achievement image by its asset ID.")]
        ...
        [Verb("uploadAchievementImage", HelpText = "Uploads an achievement image to a specific SCID.")]
        ...
        [Verb("getSandboxes", HelpText = "Gets a list of a sandboxes for a given account.")]
